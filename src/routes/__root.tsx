...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "RR Engenharia – Engenharia, Reformas e Manutenção Predial" },
      { property: "og:description", content: "Obras com precisão técnica, prazos rigorosos e acabamento de alto padrão." },
